...
export default function AboutPage()
{
    return (
        ...
        <>
            ...
            <RevealComponent
            content={
            <NoteComponent title={'1. Финансовая независимость'}
            ...
            <RevealComponent
            content={
            <NoteComponent title={'2. Легальность'}
            ...
            <RevealComponent
            content={
            <NoteComponent title={'3. Наличие налогового вычета'}
            ...
            <RevealComponent
            content={
            <NoteComponent title={'4. Оплата через сертификат Навигатора'}
            ...
            <div className="right_text_about about_section">
                ...
                <p></p>
                <p><br/>И, получается, наш Центр имеет привилегии, которые есть у государственных организаций, а сервис, который мы предлагаем, сильно отличается.<br/><br/>Мы очень стараемся и верим, что у нас это получается, а наши студенты – это замечательные люди, которых мы очень ценим!<br/></p>
            </div>
            }/>
        </>
        }
